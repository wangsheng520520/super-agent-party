...
## 特别说明
1. 本开源项目的部分功能（如 Edge TTS 语音合成、B 站 WebSocket 弹幕监听等）依赖于第三方服务的公开接口或实验性功能。这些功能可能随时因第三方政策调整而失效，开发者不对其稳定性、合法性或持续性承担责任。
...
4. 敏感信息警告：请勿在银行、支付网关或涉及高度机密信息的页面使用本工具。用户因操作不当导致的隐私泄露，开发者不承担责任。
